...
ActiveRecord::Schema[8.1].define(version: 2026_07_03_000000) do
  ...
  create_table "links", force: :cascade do |t|
    ...
    t.string "url"
    t.index ["produce_id"], name: "index_links_on_produce_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "produces_deleted_count", default: 0, null: false
    t.datetime "remember_created_at"
    t.datetime "reset_password_sent_at"
    t.string "reset_password_token"
    t.integer "seasons_deleted_count", default: 0, null: false
  ...
  create_table "vouches", force: :cascade do |t|
    ...
    t.bigint "user_id", null: false
    t.boolean "value"
    t.index ["season_id"], name: "index_vouches_on_season_id"
  ...
  add_foreign_key "vouches", "seasons"
